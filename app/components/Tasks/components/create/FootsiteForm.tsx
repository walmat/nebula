...
import RotateProxyField from './UseRotateProxies';
...
const FootsiteForm = ({ activeStep, isEditing }: FormProps) => {
        ...
        <FormikProvider value={formikbag}>
          <DialogContent className={styles.dialogContent}>
            <div className={styles.fieldset}>
              ...
              />
              <RotateProxyField
                label="Enable/Disable Proxy Rotation"
                onChange={_editTask}
                rotate={rotate}
                task={task}
              />
