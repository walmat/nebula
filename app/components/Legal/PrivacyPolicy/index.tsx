...
import { PRIVACY_POLICY_PAGE_TITLE, EFFECTIVE_DATE } from '../../../constants';
    ...
    return (
      <div className={styles.root}>
        ...
        <Typography variant="h5">
          Privacy policy for <span className={styles.bold}>{APP_NAME}</span>
        </Typography>
        <div className={styles.body}>
          ...
          <p>
            <span>
              ...
              Source app. This SERVICE is provided by {AUTHOR_NAME} at an agreed
              $35 (USD) per month, and is intended for use as is.
            </span>
          </p>
          <p>
            <span>
          ...
          <p>
            <span>
              <strong className={styles.heading}>Use of Data</strong>
            </span>
          </p>
          <p>
            <span>
          ...
          <p>
            <span>
              <strong className={styles.heading}>Transfer Of Data</strong>
            </span>
          </p>
          <p>
            <span>
          ...
          <p>
            <span>
              <strong className={styles.heading}>Disclosure Of Data</strong>
            </span>
          </p>
          <p>
          ...
          <p>
            <span>
              <strong className={styles.heading}>Security Of Data</strong>
            </span>
          </p>
          <p>
            <span>
          ...
          <p>
            <span>
              <strong className={styles.heading}>Service Providers</strong>
            </span>
          </p>
          <p>
            <span>
          ...
          <p>
            <span>
              <strong className={styles.heading}>Analytics</strong>
            </span>
          </p>
          <p>
            <span>
          ...
          <p>
            <span>
              <strong className={styles.heading}>Links To Other Sites</strong>
            </span>
          </p>
          <p>
            <span>
          ...
          <p>
            <span>
              <strong className={styles.heading}>Plugins or Add-ons</strong>
            </span>
          </p>
          <p>
            <span>
          ...
          <p>
            <span>
              <strong className={styles.heading}>Crash Reports</strong>
            </span>
          </p>
          <p>
            <span>
              ...
              &quot;~/.io.ganeshrvel/{APP_IDENTIFIER}/logs/&quot; folder. You
              may choose to send us these log files by selecting the
          ...
          <p>
            <span>
              <strong className={styles.heading}>Children&#39;s Privacy</strong>
            </span>
          </p>
          <p>
            <span>
          ...
          <p>
            <span>
              ...
              <a
                onClick={events => {
                  openExternalUrl(APP_WEBSITE, events);
                }}
              >
                our Twitter
              </a>
